...
const questions = [
    ...
    {
        id: 5,
        text: "Does your child express worries or anxiety about specific things?If yes,please specify:",
        options: [
    ...
    {
        id:10,
        text: "Does your child have any chronic health conditions or medical concerns?",
        options: [
            {label: "please Mention", value: "1"},
        ]
    },
    {
        id: 11,
    ...
    {
        id: 13,
        text: "Are there any difficulties with sleep?",
        options: [
    ...
    {
        id: 16,
        text: "Do you think the child is scoring up to his full potential",
        options: [
            {label: "Yes", value: "0"},
            {label: "No", value: "1"},
            {label: "Don’t Know", value: "2"}
    ...
    {
        id: 17,
        text: "Who will decide the child’s career goal?",
        options: [
            {label: "Child", value: "0"},
    ...
    {
        id: 19,
        text: "What does your child prefer to eat?",
        options: [
            {label: "Home Cooked Food", value: "0"},
            {label: "Junk Food", value: "1"},
            {label: "Both", value: "2"},
        ]
    },
    {
        id: 20,
        text: "Does your child have a healthy appetite?",
        options: [
            {label: "Yes", value: "0"},
            {label: "No", value: "1"},
            {label: "Don’t Know", value: "2"},
    ...
    {
        id: 21,
        text: "Are there any concerns about your child's weight or nutrition?",
        options: [
            {label: "Yes", value: "0"},
            {label: "No", value: "1"},
            {label: "Don’t Know", value: "2"},
    ...
    {
        id: 24,
        text: "Are there any rules or restrictions in place regarding screen time?",
        options: [
            {label: "Yes", value: "0"},
            {label: "No", value: "1"},
            {label: "Sometimes", value: "2"},
    ...
    {
        id: 25,
        text: "Does the Child Follow the restrictions?",
        options: [
            {label: "Regularly", value: "0"},
    ...
    {
        id: 27,
        text: "Has the child threatened you regarding restrictions?",
        options: [
            {label: "Yes", value: "0"},
            {label: "No", value: "1"},
        ]
    ...
    {
        id: 29,
        text: "Are there any concerns about safety or potential hazards in your child's environment?",
        options: [
            {label: "Yes", value: "0"},
            {label: "No", value: "1"},
            {label: "Don’t Know", value: "2"},
    ...
    {
        id: 30,
        text: "Is there open communication between your child and trusted adults regarding safety concerns?",
        options: [
            {label: "Yes", value: "0"},
            {label: "No", value: "1"},
            {label: "Don’t Know", value: "2"},
    ...
    {
        id: 31,
        text: "Does your child get disturbed in the presence of any specific person inside or outside the family?",
        options: [
            {label: "Yes", value: "0"},
            {label: "No", value: "1"},
            {label: "Never Observed", value: "2"},
        ]
    },
    {
        id: 32,
        text: "Does your child think of self or his/her body as repulsive, dirty or bad?",
        options: [
            {label: "Yes", value: "0"},
            {label: "No", value: "1"},
            {label: "Never Observed", value: "2"},
    ...
    {
        id: 33,
        text: "Have you ever observed sudden money, gifts, or toys from an unknown person?",
        options: [
            {label: "Yes", value: "0"},
            {label: "No", value: "1"},
            {label: "Never Observed", value: "2"},
                ...
                <Container maxWidth="lg">
                    <Box
                        ...
                        >
                            <PDFDownloadLink
                                document={<PdfView data={{
                                    title: " SHAPE-K12 Assessment Result",
                                    maxScore: 80,
