...
// }));
//
// const ChildLearningAbilityAssessment = () => {
...
// };
//
// export default ChildLearningAbilityAssessment;
...
const ChildLearningAbilityAssessment = () => {
    ...
    const handleStartAssessment = () => {
        navigate('/assessments/child-learning-ability/assessment-form');
    };
                        ...
                        <StyledPaper>
                            ...
                            <Box sx={{mb: 3}}>
                                <Typography sx={{
                                    ...
                                    •  This self-assessment helps you understand your child’s learning development across five key
                                    areas
                                </Typography>
                                <Typography sx={{
                                    mb: 2,
                                    ...
                                    • It is based on your observations over the past 6 months
                                </Typography>
                                <Typography sx={{
                                    mb: 2,
                                    color: '#4B5563',
                                ...
                                <Typography sx={{
                                    ...
                                    • This is a screening tool only, not a formal diagnosis
                                </Typography>
                                <Typography sx={{
                                    color: '#4B5563',
                                    fontSize: '14px',
                                    ...
                                    • If you notice patterns of concern, consult a child psychologist, developmental pediatrician,
                                    or special educator
                                </Typography>
                            </Box>
