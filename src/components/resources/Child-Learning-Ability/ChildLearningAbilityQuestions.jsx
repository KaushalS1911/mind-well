...
const questions = [
    {
        id: 1,
        text: "My child follows simple instructions the first or second time they are told.",
        options
    },
    {
        id: 2,
        text: "My child can focus on one activity (like reading, homework, or drawing) for 15–30 minutes.",
        options
    },
    {
        id: 3,
        text: "My child uses age-appropriate words and sentences while speaking.",
        options
    },
    {
        id: 4,
        text: "My child remembers names, daily routines, or instructions easily.",
        options
    },
    {
        id: 5,
        text: "My child can write or copy letters and numbers suitable for their age.",
        options
    },
    {
        id: 6,
        text: "My child understands order or sequences, like days of the week or steps in a story.",
        options
    },
    {
        id: 7,
        text: "My child understands “if this, then that” situations (cause and effect).",
        options
    },
    {
        id: 8,
        text: "My child asks questions or shows curiosity to learn something new.",
        options
    },
    {
        id: 9,
        text: "My child can group objects by color, size, or shape.",
        options
    },
    {
        id: 10,
        text: "My child enjoys solving puzzles or brain games.",
        options
    },
    {
        id: 11,
        text: "My child can move from one task to another without emotional upset.",
        options
    },
    {
        id: 12,
        text: "My child holds a pencil or crayon correctly while writing or drawing.",
        options
    }, {
        id: 13,
        text: "My child can draw basic shapes or write their name clearly (for their age).",
        options
    }, {
        id: 14,
        text: "My child is able to cut with scissors, color within lines, or build with blocks.",
        options
    }, {
        id: 15,
        ...
        id: 16,
        text: "My child speaks clearly and in full sentences as expected for their age.",
        options
    }, {
        id: 17,
        text: "My child listens when someone talks and gives a suitable reply.",
        options
    }, {
        id: 18,
        text: "My child can express their feelings or needs using words.",
        options
    }, {
        id: 19,
        ...
        id: 21,
        text: "My child manages frustration or anger without hitting, shouting, or hurting.",
        options
    }, {
        id: 22,
        text: "My child gets along well with other children (sharing, taking turns, etc.).",
        options
    }, {
        id: 23,
        text: "My child shows confidence when learning or trying new things.",
        options
    }, {
        id: 24,
        text: "My child gets distracted easily or acts without thinking.",
        options
    }, {
        id: 25,
        text: "My child seems nervous, shy, or sad in school or social settings.",
        options
    }
];
