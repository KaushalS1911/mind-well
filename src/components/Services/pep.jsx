            ...
            <CardContent sx={{ p: 4 }}>
                ...
                <List disablePadding>
                    {points.map((item, index) => (
                        <ListItem key={index} disablePadding sx={{ py: 1.5, pl: 2, borderLeft: `2px solid ${colors.secondary}`, mb: 1.5 }}>
            ...
            <Box sx={{ backgroundColor: "#022662", padding: "120px 0 60px 0" }}>
                <Grid container spacing={4} sx={{ mt: 8, px: { xs: 4, md: 10 } }}>
                    <Grid item xs={12} md={6}>
                        ...
                        <Typography variant="body1" paragraph sx={{ color: 'rgba(255,255,255,0.7)', mb: 4, maxWidth: { xs: '100%', sm: '90%', md: '80%' } }}>
                            A focused programme crafted for aspirants of rigorous entrance exams and their mentors, addressing personal challenges that impact mental clarity and emotional stability.
                        </Typography>
                    </Grid>
            ...
            <Container maxWidth="xl">
                <Box sx={{ padding: "96px 0 0 0" }}>
                    <Grid container spacing={4} mb={8}>
                        <Grid item xs={12} lg={8}>
                            <Typography className="Montserrat" fontWeight="bold" gutterBottom sx={{ color: colors.primary, fontSize: "30px", mb: 3, letterSpacing: "-1px" }}>
                                Comprehensive Performance Enhancement Program
                            </Typography>
                            <Typography variant="body1" paragraph color="text.secondary">
                                PEP builds psychological resilience, sharpens focus, and provides proven strategies to excel under pressure for both exam aspirants and their mentors.
                            </Typography>
                            <Typography variant="body1" color="text.secondary">
                                Our program integrates emotional wellness with academic excellence, preparing aspirants not just for exam success but for life-long resilience and personal growth.
                            </Typography>
                        </Grid>
                        <Grid item xs={12} lg={4}>
                            <Paper elevation={1} sx={{ p: 3, borderRadius: 2, backgroundColor: "grey.50", borderTop: `4px solid ${colors.secondary}` }}>
                ...
                <Box sx={{ padding: "96px 0" }}>
                    <Box textAlign="center" mb={6}>
                        <Typography className="Montserrat" variant="h4" fontWeight="bold" gutterBottom sx={{ color: colors.primary, fontSize: { xs: '32px', md: '40px' } }}>
                            Our Two-Pillar Approach
                        </Typography>
                        <Typography variant="body1" color="text.secondary" sx={{ maxWidth: "md", mx: "auto", fontSize: { xs: "16px", md: "20px" } }}>
                            PEP delivers comprehensive support through two integrated components that work together to create lasting positive impact for both mentors and aspirants.
                        </Typography>
                    </Box>
