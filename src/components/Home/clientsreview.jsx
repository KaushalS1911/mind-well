...
const reviews = [
    ...
    },
    {
        ...
        review:
            "\"After years of caring for others, I was suffering from severe burnout. My therapist at EmotionallYours understood the unique stressors of healthcare work. The specialized techniques for compassion fatigue have been invaluable. I'm rediscovering my passion for my work.\"",
    },
    {
        name: "David H.",
        ...
        <Box sx={{p: "96px 0 0 0"}}>
            <Container maxWidth={"xl"}>
                ...
                <Box sx={{textAlign: "center", opacity: 0.7, mb: 3, fontSize: "20px",}}>
                    ...
                    their mental wellness journey with EmotionallYours.
                </Box>
