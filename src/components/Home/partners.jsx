...
const testimonials = [
    {
        ...
        feedback:
            "Implementing MindWell's employee mental health program has been transformative for our company culture. Our team feels supported, productivity has increased, and we've seen a significant reduction in absenteeism.",
    },
    {
        initials: "MR",
        ...
        feedback:
            "As a company that prioritizes employee wellbeing, partnering with MindWell was an obvious choice. The ROI has been clear – lower turnover, higher engagement, and a team that feels genuinely cared for.",
    },
    {
        initials: "SP",
        name: "Sarah Patel",
