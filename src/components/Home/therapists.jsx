...
const struggles = [
    {
        icon: <WarningAmberIcon sx={{fontSize: 30, color: "#012765"}}/>,
        title: "Anxiety",
    ...
    {
        icon: <SelfImprovementIcon sx={{fontSize: 30, color: "#012765"}}/>,
        title: "Depression",
    ...
    {
        icon: <DeviceThermostatIcon sx={{fontSize: 30, color: "#012765"}}/>,
        title: "Stress",
    ...
    {
        icon: <HeartBrokenIcon sx={{fontSize: 30, color: "#012765"}}/>,
    ...
    {
        icon: <SecurityIcon sx={{fontSize: 30, color: "#012765"}}/>,
        title: "Trauma & PTSD",
    ...
    {
        icon: <TrendingUpIcon sx={{fontSize: 30, color: "#012765"}}/>,
        title: "Self-esteem",
