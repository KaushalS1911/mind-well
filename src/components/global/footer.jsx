...
const SOCIAL_MEDIA_LINKS = [
  {
    icon: <LinkedIn />,
    link: "https://www.linkedin.com/company/emotionallyours/",
  },
  { icon: <Facebook />, link: "https://www.facebook.com/share/1AmSYda79K/" },
  {
    icon: <Instagram />,
    link: "https://www.instagram.com/mann_miitr?igsh=cWp1aWNiNm1vNzNx",
  },
  {
    icon: <YouTube />,
...
const contactDetails = {
  emails: [{ icon: <MailOutlineIcon />, value: "connect@emotionallyours.com" }],
  addresses: [
    {
      icon: <LocationOnIcon />,
    ...
    },
    {
      icon: <LocationOnIcon />,
      value:
        "Reg. Office: B-130, Unit-29, Mastermind Aareymilk Colony Goregaon East, Mumbai, Maharashtra-400063",
    },
  ],
};
      ...
      <Container maxWidth="xl">
        <Grid container spacing={4} justifyContent="center">
          <Grid item xs={12} lg={5}>
            ...
            >
              "Emotionally Yours" provides accessible, professional mental
              health services for students and professionals. Our mission is to
              make quality therapy and mental wellness resources available to
            ...
            {services.map((service, index) => (
              ...
              >
                <Link
                  ...
                  underline="none"
                >
                  <Box component="a">{service.name}</Box>
                </Link>
              </Box>
            ))}
          </Grid>
          ...
          <Grid item xs={12} sm={5} md={6} lg={3}>
            ...
            >
              ...
              {contactDetails.emails.map((email, index) => (
                ...
                >
                  <Box sx={{ color: "#FE6A00", mr: 1 }}>{email.icon}</Box>
                  {email.value}
                </Box>
              ))}
              ...
              {contactDetails.addresses.map((address, index) => (
                ...
                >
                  <Box sx={{ color: "#FE6A00", mr: 1 }}>{address.icon}</Box>
                  {address.value}
                </Box>
              ))}
            </Box>
        ...
        <Box>
          ...
          >
            ...
            <Typography variant="body2" sx={{ color: "#FFFFFFCC", mb: 2 }}>
              ...
              you are feeling suicidal, we suggest you immediately call a
              suicide prevention helpline like KIRAN: 18005990019 (24 hours, 7
              days a week)
            </Typography>
